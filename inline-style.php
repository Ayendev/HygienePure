<?php
	...
	$sirat_button_font_size = get_theme_mod('sirat_button_font_size',14);
	$sirat_custom_css .='.more-btn a{';
		$sirat_custom_css .='font-size: '.esc_attr($sirat_button_font_size).';';
	$sirat_custom_css .='}';

	$sirat_theme_lay = get_theme_mod( 'sirat_button_text_transform','Uppercase');
	if($sirat_theme_lay == 'Capitalize'){
		$sirat_custom_css .='.more-btn a{';
			$sirat_custom_css .='text-transform:Capitalize;';
		$sirat_custom_css .='}';
	}
	if($sirat_theme_lay == 'Lowercase'){
		$sirat_custom_css .='.more-btn a{';
			$sirat_custom_css .='text-transform:Lowercase;';
		$sirat_custom_css .='}';
	}
	if($sirat_theme_lay == 'Uppercase'){
		$sirat_custom_css .='.more-btn a{';
			$sirat_custom_css .='text-transform:Uppercase;';
		$sirat_custom_css .='}';
	}
    ...
    if($sirat_footer_widgets_content == 'Left'){
		$sirat_custom_css .='#footer li{';
		$sirat_custom_css .='text-align: left;';
		$sirat_custom_css .='}';
	}else if($sirat_footer_widgets_content == 'Center'){
		$sirat_custom_css .='#footer li{';
			$sirat_custom_css .='text-align: center;';
		$sirat_custom_css .='}';
	}else if($sirat_footer_widgets_content == 'Right'){
		$sirat_custom_css .='#footer li{';
			$sirat_custom_css .='text-align: right;';
		$sirat_custom_css .='}';
	}

	$sirat_footer_padding = get_theme_mod('sirat_footer_padding');
    ...
    if($sirat_footer_widgets_heading == 'Left'){
		...
		$sirat_custom_css .='}';
		$sirat_custom_css .='#footer h3:after, #footer label.wp-block-search__label:after{';
			$sirat_custom_css .='margin-left: auto;';
		$sirat_custom_css .='}';
	}
